    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            ...
            <label class="form-label" for="typeEmailX-2">Name</label>
              <input name="nom" type="text" required id="typeNameX-2" class="form-control form-control-lg" />
           
            </div>
            <div class="form-outline mb-4">
            <label class="form-label" for="typeEmailX-2">Family Name</label>
              <input  name="prenom" required  type="text" id="typeFamilyX-2" class="form-control form-control-lg" />
            
            </div>
            <div class="form-outline mb-4">
            <label class="form-label" for="typeEmailX-2">Email</label>
              <input  name="email" required  type="email" id="typeEmailX-2" class="form-control form-control-lg" />
          
            </div>
            <div class="form-outline mb-4">
            <label class="form-label" for="typeEmailX-2">Tel</label>
              <input   name="tel"required   type="tel" id="typeTelX-2" class="form-control form-control-lg" />
        
            </div>
            <div class="form-outline mb-4">
            <label class="form-label" for="typePasswordX-2">Password</label>
              <input   name="mdp" required  type="password" id="typePasswordX-2" class="form-control form-control-lg" />
