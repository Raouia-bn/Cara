...
<!--list des categories-->
  ...
  <tbody>
    ...
    <td><a href="supprimer.php?idc='.$categorie['id'].'"><i  style="font-size:25px;color:#088178" class="fa fa-trash-o "></i></a>     
     <a data-bs-toggle="modal" data-bs-target="#updateModal'.$categorie['id'].'"> <i    style="font-size:25px;color:#088178" class="fa fa-refresh fa-spin " ></i><a></td>
  </tr>';}
    ?>
